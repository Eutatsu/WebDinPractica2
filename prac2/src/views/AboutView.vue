...
<div class="about py-4 container">
  <h2>Sobre el Mosaic</h2>
    <p>El Mosaic Casteller és un experiment visual que recull dades sobre les diferents Colles Castelleres de Catalunya i més enllà, tant les actualment actives com les que han desaparegut per una raó o altra.
  ...
  <h3>Investigació</h3>
    ...
    ha esdevingut també una tasca de recerca i investigació.</p><p>
